...
public static class FbExpression
{
    ...
    public const int Tongue_Tip_Interdental = 63;
    public const int Tongue_Tip_Alveolar = 64;
    ...
    public const int Left_Pos_X = 71;
    public const int Left_Pos_Y = 72;
    public const int Left_Pos_Z = 73;
    public const int Left_Rot_X = 74;
    public const int Left_Rot_Y = 75;
    public const int Left_Rot_Z = 76;
    public const int Left_Rot_W = 77;
    public const int Right_Pos_X = 78;
    public const int Right_Pos_Y = 79;
    public const int Right_Pos_Z = 80;
    public const int Right_Rot_X = 81;
    public const int Right_Rot_Y = 82;
    public const int Right_Rot_Z = 83;
    public const int Right_Rot_W = 84;
}